...
WorktreeTree now renders filesystem-style selector buttons with icons, indentation, `aria-current`, and non-color active affordances while remaining selector-only and CSS-hidden when empty.
